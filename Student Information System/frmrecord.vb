...
Public Class frmrecord
    ...
    Private Sub Student_BehaviourDataGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Student_BehaviourDataGridView.CellContentClick

    End Sub

    Private Sub Student_BehaviourBindingSource_CurrentChanged(sender As Object, e As EventArgs) Handles Student_BehaviourBindingSource.CurrentChanged
    ...
    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ...
        con = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=stdntinfo.accdb ")
        com = New OleDbCommand("delete * from Student Behaviour where RecordID=StudentIDTextBox.Text", con)
        con.Open()
        com.Parameters.AddWithValue("@StudentIDTextBox.Text", StudentIDTextBox.Text)
        com.ExecuteNonQuery()
